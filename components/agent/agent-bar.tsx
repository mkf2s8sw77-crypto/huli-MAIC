...
export function AgentBar() {
  ...
  return (
    <div ref={containerRef} className="relative w-auto sm:w-80">
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            className={cn(
              'group flex items-center gap-2 cursor-pointer rounded-full px-2.5 py-2 transition-all w-auto sm:w-full',
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-1 z-50 w-[min(320px,calc(100vw-2rem))]"
          >
